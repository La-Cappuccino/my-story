...
const SOCIAL_LINKS = [
  {
    label: "LinkedIn",
    href:  "https://www.linkedin.com/in/allankisuule",
    icon:  (
      ...
      <div className="section-container !py-12">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3 sm:gap-8">
          ...
          <div className="flex flex-col gap-2">
            <Link
              href="/"
              className="text-base font-semibold text-[var(--text)] hover:text-[var(--accent)] transition-colors duration-200"
            >
              Allan Kisuule
            </Link>
          ...
          >
            {NAV_LINKS.map(({ label, href }) => (
              <Link
                ...
                href={href}
                className={cn(
                  "text-sm text-[var(--text-3)] link-hover",
        ...
        >
          <p className="text-xs text-[var(--text-3)]">
            &copy; {currentYear} Allan Kisuule. All rights reserved.
          </p>
          <p className="text-xs text-[var(--text-3)]">
            Built with{" "}
            <a
